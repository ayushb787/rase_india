  ...
  return (
    <div className='container-ceo-message shadow-lg-3 bg-white rounded'>   
        <div className='header-one'>
            ...
            <span className='header-one-part-two'>HON. CEO</span>
        </div>
        ...
        <div className="image-container">
            <img src={image12} alt="Mr. Pravinchandra Mundada" className='dr-img' />
            <div class="image-content">
                <h3 class="elementor-image-box-title">Mr. Pravinchandra Mundada</h3>
                <p class="elementor-image-box-description">Hon. CEO<br/>RASE, India</p>
            </div>
        </div>
    </div>
  );
